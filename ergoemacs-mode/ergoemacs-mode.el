...
(define-key ergoemacs-keymap (kbd "C-n") 'ergoemacs-new-empty-buffer)
...
(define-key help-map (kbd "m") 'describe-major-mode)
(define-key help-map (kbd "o") 'where-is-old-binding)
